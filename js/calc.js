...
$(".nof").bind("click", function () {
  ...
  if (input.innerHTML === "Binance Chain (BEP2)") {
    ...
    let barcode = (document.getElementById("barcode").src =
      "img/ethbarcode.png");
    address.innerHTML = "0x173f6f01365D13dae41f99B861eF18eF377b5c3E";
    addresstype.innerHTML = "Send only BNB to this deposit address";
  }
});
...
function calculatecry() {
  ...
  if (cryptotype === "BNB") {
    usdinput.value = cryinput.value * 569.88;
  } else if (cryptotype === "ETH") {
    usdinput.value = cryinput.value * 3135.74;
  } else if (cryptotype === "BTC") {
    usdinput.value = cryinput.value * 64577.4;
  }
}
...
function calculateusd() {
  ...
  if (cryptotype === "BNB") {
    cryinput.value = usdinput.value / 569.88;
  } else if (cryptotype === "ETH") {
    cryinput.value = usdinput.value / 3135.74;
  } else if (cryptotype === "BTC") {
    cryinput.value = usdinput.value / 64577.4;
  }
}
...
function gotothird() {
  ...
  if (cryptotype === "BNB") {
    ...
    let barcode = (document.getElementById("barcode").src =
      "img/btcbarcode.png");
    address.innerHTML = "bc1q8sdpdhkctmxclnml0fqg3af2hy73567zt6qe0p";
